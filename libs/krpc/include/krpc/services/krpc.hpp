...
class KRPC : public Service {
 public:
  ...
  /**
   * The game scene. See KRPC::game_scene.
   */
   ...
   * scene. Setting it to KRPC::GameScene::flight resumes the save's
   * active vessel, and fails if there is none.
   */
  KRPC::GameScene game_scene();
   ...
   * active vessel, and fails if there is none.
   */
  void set_game_scene(KRPC::GameScene value);
  ...
  ::krpc::Stream<KRPC::GameScene> game_scene_stream();
  ...
  ::krpc::schema::ProcedureCall game_scene_call();

  ::krpc::schema::ProcedureCall set_game_scene_call(KRPC::GameScene value);
...
inline KRPC::GameScene KRPC::game_scene() {
  std::string _data = this->_client->invoke("KRPC", "get_GameScene");
  KRPC::GameScene _result;
  decoder::decode(_result, _data, this->_client);
  return _result;
}

inline void KRPC::set_game_scene(KRPC::GameScene value) {
  std::vector<std::string> _args;
  _args.push_back(encoder::encode(value));
  this->_client->invoke("KRPC", "set_GameScene", _args);
}
...
inline ::krpc::Stream<KRPC::GameScene> KRPC::game_scene_stream() {
  return ::krpc::Stream<KRPC::GameScene>(this->_client, this->_client->build_call("KRPC", "get_GameScene"));
}
...
inline ::krpc::schema::ProcedureCall KRPC::game_scene_call() {
  return this->_client->build_call("KRPC", "get_GameScene");
}

inline ::krpc::schema::ProcedureCall KRPC::set_game_scene_call(KRPC::GameScene value) {
  std::vector<std::string> _args;
  _args.push_back(encoder::encode(value));
  return this->_client->build_call("KRPC", "set_GameScene", _args);
}
